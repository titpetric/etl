...
| ❌      | titpetric/etl/server                              | 64.44%   | 8         | 90    |
| ❌      | titpetric/etl/server/config                       | 58.94%   | 51        | 103   |
| ❌      | titpetric/etl/server/config/loader                | 14.84%   | 24        | 295   |
| ✅      | titpetric/etl/server/internal                     | 37.50%   | 2         | 19    |
| ✅      | titpetric/etl/server/internal/db/order            | 0.00%    | 0         | 14    |
| ❌      | titpetric/etl/server/internal/handler             | 32.70%   | 19        | 54    |
| ✅      | titpetric/etl/server/internal/handler/model       | 86.67%   | 2         | 18    |
| ❌      | titpetric/etl/server/internal/handler/query       | 42.86%   | 27        | 115   |
| ✅      | titpetric/etl/server/internal/handler/query/model | 71.40%   | 2         | 12    |
| ✅      | titpetric/etl/server/internal/handler/request     | 82.34%   | 33        | 174   |
| ❌      | titpetric/etl/server/internal/handler/sql         | 42.85%   | 173       | 721   |
| ❌      | titpetric/etl/server/middleware/cache             | 61.17%   | 60        | 312   |
| ❌      | titpetric/etl/server/middleware/ratelimit         | 59.99%   | 50        | 329   |
...
| ✅      | titpetric/etl/server                              | Module.Mount                     | 80.00%   | 1         |
...
| ❌      | titpetric/etl/server                              | NewHandler                       | 0.00%    | 1         |
| ✅      | titpetric/etl/server                              | NewModule                        | 100.00%  | 0         |
| ❌      | titpetric/etl/server                              | Server                           | 0.00%    | 5         |
...
| ❌      | titpetric/etl/server/config/loader                | CacheCloneManager.Get            | 0.00%    | 1         |
| ✅      | titpetric/etl/server/config/loader                | CacheCloneManager.String         | 0.00%    | 0         |
| ❌      | titpetric/etl/server/config/loader                | CacheCloneManager.loadAndSet     | 0.00%    | 2         |
| ❌      | titpetric/etl/server/config/loader                | CacheCloneManager.set            | 0.00%    | 1         |
| ❌      | titpetric/etl/server/config/loader                | CacheExpiryManager.Get           | 0.00%    | 2         |
| ✅      | titpetric/etl/server/config/loader                | CacheExpiryManager.String        | 0.00%    | 0         |
| ❌      | titpetric/etl/server/config/loader                | CacheExpiryManager.loadAndSet    | 0.00%    | 2         |
| ✅      | titpetric/etl/server/config/loader                | CacheExpiryManager.set           | 0.00%    | 0         |
| ❌      | titpetric/etl/server/config/loader                | CacheForeverManager.Get          | 0.00%    | 1         |
| ✅      | titpetric/etl/server/config/loader                | CacheForeverManager.String       | 0.00%    | 0         |
| ❌      | titpetric/etl/server/config/loader                | CacheForeverManager.loadAndSet   | 0.00%    | 2         |
| ✅      | titpetric/etl/server/config/loader                | CacheForeverManager.set          | 0.00%    | 0         |
| ❌      | titpetric/etl/server/config/loader                | CacheModifiedManager.Get         | 0.00%    | 5         |
| ✅      | titpetric/etl/server/config/loader                | CacheModifiedManager.String      | 0.00%    | 0         |
| ❌      | titpetric/etl/server/config/loader                | CacheModifiedManager.loadAndSet  | 0.00%    | 2         |
| ✅      | titpetric/etl/server/config/loader                | CacheModifiedManager.set         | 0.00%    | 0         |
| ✅      | titpetric/etl/server/config/loader                | CacheNone.Get                    | 75.00%   | 1         |
| ✅      | titpetric/etl/server/config/loader                | CacheNone.String                 | 0.00%    | 0         |
| ✅      | titpetric/etl/server/config/loader                | CacheNone.set                    | 0.00%    | 0         |
| ❌      | titpetric/etl/server/config/loader                | CacheSharedManager.Get           | 0.00%    | 1         |
| ✅      | titpetric/etl/server/config/loader                | CacheSharedManager.String        | 0.00%    | 0         |
| ❌      | titpetric/etl/server/config/loader                | CacheSharedManager.loadAndSet    | 0.00%    | 2         |
| ❌      | titpetric/etl/server/config/loader                | CacheSharedManager.set           | 0.00%    | 1         |
...
| ✅      | titpetric/etl/server/config/loader                | NewCacheCloneManager             | 0.00%    | 0         |
| ✅      | titpetric/etl/server/config/loader                | NewCacheExpiryManager            | 0.00%    | 0         |
| ✅      | titpetric/etl/server/config/loader                | NewCacheForeverManager           | 0.00%    | 0         |
| ✅      | titpetric/etl/server/config/loader                | NewCacheModifiedManager          | 0.00%    | 0         |
| ✅      | titpetric/etl/server/config/loader                | NewCacheNone                     | 100.00%  | 0         |
| ✅      | titpetric/etl/server/config/loader                | NewCacheSharedManager            | 0.00%    | 0         |
| ✅      | titpetric/etl/server/internal                     | Marshal                          | 75.00%   | 1         |
| ❌      | titpetric/etl/server/internal                     | MarshalIndent                    | 0.00%    | 1         |
| ✅      | titpetric/etl/server/internal/db/order            | Asc                              | 0.00%    | 0         |
| ✅      | titpetric/etl/server/internal/db/order            | Desc                             | 0.00%    | 0         |
| ✅      | titpetric/etl/server/internal/handler             | Server                           | 0.00%    | 0         |
| ❌      | titpetric/etl/server/internal/handler             | ServerWithEndpoints              | 65.40%   | 19        |
| ✅      | titpetric/etl/server/internal/handler/model       | DBValue                          | 60.00%   | 2         |
...
| ❌      | titpetric/etl/server/internal/handler/query       | Handler.prepareQueryParams       | 0.00%    | 10        |
...
| ✅      | titpetric/etl/server/internal/handler/request     | Handler.buildUpstreamPath        | 63.60%   | 3         |
...
| ✅      | titpetric/etl/server/internal/handler/sql         | Handler.collectParameters        | 84.60%   | 10        |
...
| ✅      | titpetric/etl/server/middleware/cache             | DefaultKeyBuilder.BuildKey       | 69.20%   | 2         |
| ✅      | titpetric/etl/server/middleware/cache             | DefaultKeyBuilder.WithHeaders    | 0.00%    | 0         |
| ✅      | titpetric/etl/server/middleware/cache             | DefaultKeyBuilder.WithPattern    | 0.00%    | 0         |
| ✅      | titpetric/etl/server/middleware/cache             | DefaultKeyBuilder.WithQuery      | 0.00%    | 0         |
| ❌      | titpetric/etl/server/middleware/cache             | DefaultKeyBuilder.extractHeaders | 0.00%    | 3         |
| ❌      | titpetric/etl/server/middleware/cache             | DefaultKeyBuilder.extractQuery   | 0.00%    | 12        |
| ✅      | titpetric/etl/server/middleware/cache             | MemoryStore.CleanupExpired       | 88.90%   | 4         |
...
| ✅      | titpetric/etl/server/middleware/cache             | MemoryStore.Set                  | 77.80%   | 2         |
...
| ✅      | titpetric/etl/server/middleware/ratelimit         | DefaultKeyBuilder.BuildKey       | 71.40%   | 2         |
| ✅      | titpetric/etl/server/middleware/ratelimit         | DefaultKeyBuilder.WithHeaders    | 0.00%    | 0         |
| ✅      | titpetric/etl/server/middleware/ratelimit         | DefaultKeyBuilder.WithPattern    | 100.00%  | 0         |
| ✅      | titpetric/etl/server/middleware/ratelimit         | DefaultKeyBuilder.WithQuery      | 0.00%    | 0         |
| ❌      | titpetric/etl/server/middleware/ratelimit         | DefaultKeyBuilder.extractHeaders | 0.00%    | 3         |
| ❌      | titpetric/etl/server/middleware/ratelimit         | DefaultKeyBuilder.extractQuery   | 0.00%    | 12        |
| ✅      | titpetric/etl/server/middleware/ratelimit         | DefaultKeyBuilder.getClientIP    | 70.00%   | 5         |
| ✅      | titpetric/etl/server/middleware/ratelimit         | MemoryStore.CleanupExpired       | 88.90%   | 4         |
| ✅      | titpetric/etl/server/middleware/ratelimit         | MemoryStore.Clear                | 83.30%   | 1         |
| ✅      | titpetric/etl/server/middleware/ratelimit         | MemoryStore.Inc                  | 84.60%   | 3         |
| ✅      | titpetric/etl/server/middleware/ratelimit         | MemoryStore.Rate                 | 80.00%   | 3         |
| ✅      | titpetric/etl/server/middleware/ratelimit         | MemoryStore.Reset                | 83.30%   | 1         |
